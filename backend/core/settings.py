...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='it_project_management'),
...
AUTH_PASSWORD_VALIDATORS = [
    {
        ...
        'OPTIONS': {
            'min_length': 6,  # Minimum 6 caractères au lieu de 8
        }
    },
    # Commenté pour faciliter les tests
    # {
...
DEFAULT_FROM_EMAIL = f'IT Project Manager <{config("EMAIL_HOST_USER", default="noreply@company.com")}>'
MEDIA_URL = '/media/'
